...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\tau_lidar_pub\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\tau_lidar_pub\hook\ament_prefix_path.bat"

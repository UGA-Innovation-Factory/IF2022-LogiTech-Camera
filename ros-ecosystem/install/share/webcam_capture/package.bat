...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webcam_capture\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webcam_capture\hook\ament_prefix_path.bat"

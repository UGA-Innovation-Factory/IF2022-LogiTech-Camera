...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webcam_publisher\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webcam_publisher\hook\ament_prefix_path.bat"

...
set "AMENT_ENVIRONMENT_HOOKS[mediapipe_ros]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mediapipe_ros] "%AMENT_CURRENT_PREFIX%\share\mediapipe_ros\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mediapipe_ros] "%AMENT_CURRENT_PREFIX%\share\mediapipe_ros\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mediapipe_ros] "%AMENT_CURRENT_PREFIX%\share\mediapipe_ros\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[mediapipe_ros]:;=";"%") do (
    call:call_file %%f
  )

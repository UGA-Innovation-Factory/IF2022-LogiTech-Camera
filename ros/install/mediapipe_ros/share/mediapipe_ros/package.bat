...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\mediapipe_ros\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\mediapipe_ros\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/mediapipe_ros/local_setup.bat"
